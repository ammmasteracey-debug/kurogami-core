...
export default function HomePage() {
  ...
  const moveArtistCarousel = (direction: 'left' | 'right') => {
    artistCarouselRef.current?.scrollBy({
      left: direction === 'right' ? artistCarouselRef.current.clientWidth : -artistCarouselRef.current.clientWidth,
      behavior: 'smooth',
    })
  }
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pb-32 sm:px-8 lg:px-10">
        ...
        <section className="section artists-section">
          <div className="panel-card p-10">
            ...
            <div className="artist-carousel-controls mt-8">
              <button type="button" className="artist-carousel-arrow" aria-label="Previous artist" onClick={() => moveArtistCarousel('left')}>
                <span aria-hidden="true">←</span>
              </button>
              <div className="artist-carousel-dots" aria-hidden="true">
                {artists.map((artist) => <span key={artist.id} className="artist-carousel-dot" />)}
              </div>
              <button type="button" className="artist-carousel-arrow" aria-label="Next artist" onClick={() => moveArtistCarousel('right')}>
                <span aria-hidden="true">→</span>
              </button>
            </div>

            <div ref={artistCarouselRef} className="artist-carousel mt-4">
              {artists.map((a) => (
                  ...
                  <div className="artist-body p-4">
                    ...
                    <div className="mt-auto pt-4">
                      ...
                      {a.ctaLink && a.ctaLabel && (
                        <a href={a.ctaLink} target="_blank" rel="noreferrer" className="btn btn-secondary ml-2">
                          {a.ctaLabel}
                        </a>
                      )}
                    </div>
